...
@WebServlet(name = "ReporteMaterias", urlPatterns = {"/ReporteMaterias"})
public class ReporteMaterias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReporteMaterias</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Reporte de Materias</h1>");
...
//                        + "databaseName=Fica;user=sa;password=sasql");
                ...
                while (rs.next()) {
                    ...
                    out.println();
                    out.println("Codigo de materia: " + rs.getInt("codMateria")+"<br>");    
                    out.println("Nombre de materia: "+rs.getString("nomMateria")+"<br>");
